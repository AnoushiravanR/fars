...
Before you load and attach this package you need to load all of 
...
This function first calls `make_filename` to create a file name of a 
specified year:
...
It then makes use of `fars_read` to read the generated file names into R 
...
vector containing four-digit numeric values of years.  The function then
binds the imported data sets and groups them by year and MONTH columns. 
